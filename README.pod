...
available in the mrcal APT repo. See:

 https://mrcal.secretsauce.net/install.html
...
the Debian package definition:

  https://salsa.debian.org/science-team/libdogleg/-/blob/master/debian/control
